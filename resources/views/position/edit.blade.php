        ...
        <div class="card">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Add New Position</span>
                </h3>
            </div>
            <div class="card-body py-3">
                {!! Form::model($position, ['route' => ['position.update', $position->id], 'method' => 'put']) !!}
                    ...
                    <div class="row mb-10 align-items-center">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                {!! Form::text('code', null, ['class' => 'form-control form-control-lg form-control-solid', 'required']) !!}
                            </div>
                        </div>
                        @error('code')
                            <small class="form-text text-danger">{{ $message }}</small>
